...
public class MyAdapter9 extends RecyclerView.Adapter<MyViewHolder> {
    private Context context;
    private List<Profile> dataList;

    public MyAdapter9(Context context, List<Profile> dataList) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.recCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, DetailActivity9.class);
