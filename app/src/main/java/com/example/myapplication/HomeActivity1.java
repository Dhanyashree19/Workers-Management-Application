...
public class HomeActivity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GridLayoutManager gridLayoutManager = new GridLayoutManager(HomeActivity1.this, 1);
        ...
        adapter = new MyAdapter1(HomeActivity1.this, dataList);
        recyclerView.setAdapter(adapter);
        databaseReference = FirebaseDatabase.getInstance().getReference().child("Profiles1");
        dialog.show();
        ...
        profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(HomeActivity1.this, ProfileActivity1.class);
            }
        });
        category.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(HomeActivity1.this, CategoryActivity.class);
            }
        });
        ...
        about_us.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(HomeActivity1.this, AboutActivity.class);
            }
        });
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(HomeActivity1.this, ProfileActivity1.class);
                startActivity(intent);
            }
        });
    }
