...
public class ProfileActivity5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(ProfileActivity5.this, HomeActivity.class);
            }
        });
        ...
        category.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(ProfileActivity5.this, CategoryActivity.class);
            }
        });
        ...
        about_us.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(ProfileActivity5.this, AboutActivity.class);
            }
        });
        ...
        logout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(ProfileActivity5.this, MainActivity.class);
    ...
    private void saveProfile() {
        ...
        Toast.makeText(ProfileActivity5.this,"Profile saved",Toast.LENGTH_LONG).show();
    }
