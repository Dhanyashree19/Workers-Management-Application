...
public class MyAdapter7 extends RecyclerView.Adapter<MyViewHolder> {
    private Context context;
    private List<Profile> dataList;

    public MyAdapter7(Context context, List<Profile> dataList) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.recCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, DetailActivity7.class);
