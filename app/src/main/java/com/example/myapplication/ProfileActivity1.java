...
public class ProfileActivity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(ProfileActivity1.this, HomeActivity.class);
            }
        });
        ...
        category.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(ProfileActivity1.this, CategoryActivity.class);
            }
        });
        ...
        about_us.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                redirectActivity(ProfileActivity1.this, AboutActivity.class);
            }
        });
    ...
    private void saveProfile() {
        ...
        Toast.makeText(ProfileActivity1.this,"Profile saved",Toast.LENGTH_LONG).show();
    }
