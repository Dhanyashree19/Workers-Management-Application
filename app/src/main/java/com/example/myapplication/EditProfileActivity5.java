...
public class EditProfileActivity5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_profile5);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("Profiles5").child(profileKey);
    ...
    private void retrieveProfileData() {
        databaseReference.get().addOnSuccessListener(snapshot -> {
            if (snapshot.exists()) {
                ...
                Toast.makeText(EditProfileActivity5.this, "Profile not found", Toast.LENGTH_SHORT).show();
                finish();
            }
        }).addOnFailureListener(e -> {
            Toast.makeText(EditProfileActivity5.this, "Failed to retrieve profile", Toast.LENGTH_SHORT).show();
            finish();
        });
    }
    ...
    private void updateProfile() {
        ...
        databaseReference.setValue(profile).addOnSuccessListener(aVoid -> {
            Toast.makeText(EditProfileActivity5.this, "Profile updated successfully", Toast.LENGTH_SHORT).show();
            finish();
        }).addOnFailureListener(e -> {
            Toast.makeText(EditProfileActivity5.this, "Failed to update profile", Toast.LENGTH_SHORT).show();
        });
    }
