    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        deleteBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference databaseRef = FirebaseDatabase.getInstance().getReference("Profiles6");
                ...
                databaseRef.child(key).removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        // Delete successful
                        Toast.makeText(DetailActivity6.this, "Profile deleted successfully", Toast.LENGTH_SHORT).show();
        ...
        editButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DetailActivity6.this, EditProfileActivity6.class);
