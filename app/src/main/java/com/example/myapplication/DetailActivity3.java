...
public class DetailActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        deleteBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference databaseRef = FirebaseDatabase.getInstance().getReference("Profiles3");
                ...
                databaseRef.child(key).removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        // Delete successful
                        Toast.makeText(DetailActivity3.this, "Profile deleted successfully", Toast.LENGTH_SHORT).show();
        ...
        editButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DetailActivity3.this, EditProfileActivity3.class);
    ...
    private void openMessagingApp() {
        ...
        if (phoneNumber != null && !phoneNumber.isEmpty()) {
            ...
            intent.putExtra("sms_body", "Hello,Hello, I recently came across your profile on WorkEase.Please let me know if there's a convenient time for us to connect.");
